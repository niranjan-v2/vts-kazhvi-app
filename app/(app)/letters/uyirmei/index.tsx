...
const UYIRMEI_MAP: Record<string, UyirmeiEntry> = {
    ...
    't_a':  { glyph: 'ட',  wordTa: 'டமாரம்' },
    't_aa': { glyph: 'டா', wordTa: 'டாக்டர்' },
    't_i':  { glyph: 'டி', wordTa: 'டிக்கெட்' },
    't_ii': { glyph: 'டீ', wordTa: 'டீ' },
    't_u':  { glyph: 'டு', wordTa: 'டுடு' },
    't_uu': { glyph: 'டூ', wordTa: 'டூட்டி' },
    't_e':  { glyph: 'டெ', wordTa: 'டெஸ்ட்' },
    't_ee': { glyph: 'டே', wordTa: 'டேபிள்' },
    't_ai': { glyph: 'டை', wordTa: 'டைரி' },
    't_o':  { glyph: 'டொ', wordTa: 'டொலர்' },
    't_oo': { glyph: 'டோ', wordTa: 'டோசா' },
    't_au': { glyph: 'டௌ', wordTa: 'டௌலிங்' },

    'n_a':  { glyph: 'ண',  wordTa: 'ண' },
    'n_aa': { glyph: 'ணா', wordTa: 'ணா' },
    'n_i':  { glyph: 'ணி', wordTa: 'மணி' },
    'n_ii': { glyph: 'ணீ', wordTa: 'பாணீ' },
    'n_u':  { glyph: 'ணு', wordTa: 'அணு' },
    'n_uu': { glyph: 'ணூ', wordTa: 'கணூ' },
    'n_e':  { glyph: 'ணெ', wordTa: 'கணெ' },
    'n_ee': { glyph: 'ணே', wordTa: 'கணே' },
    'n_ai': { glyph: 'ணை', wordTa: 'அணை' },
    'n_o':  { glyph: 'ணொ', wordTa: 'கணொ' },
    'n_oo': { glyph: 'ணோ', wordTa: 'கணோ' },
    'n_au': { glyph: 'ணௌ', wordTa: 'கணௌ' },
